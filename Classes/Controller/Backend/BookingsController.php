    ...
    implements FilterableControllerInterface
{
    use AudienceRepositoryTrait, CategoryRepositoryTrait, CompanyRepositoryTrait,
        DemandTrait, DownloadTrait, EventTypeRepositoryTrait, FilterableControllerTrait,
        GenreRepositoryTrait, ModuleDataTrait, NotificationRepositoryTrait, PersonRepositoryTrait,
    ...
    protected function createDemandFromSettings($settings)
    {
        ...
        return $this->reservationDemandFactory->createFromSettings($settings);
    }
