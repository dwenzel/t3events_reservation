 ...
 */
class ContactControllerDefaultsTest extends UnitTestCase
{
    /**
     * @var ContactControllerDefaults|\PHPUnit_Framework_MockObject_MockObject|\TYPO3\CMS\Core\Tests\AccessibleObjectInterface
     */
    protected $subject;
    ...
    public function setUp()
    {
        $this->subject = $this->getAccessibleMock(
            ContactControllerDefaults::class, ['dummy']
        );
    }
