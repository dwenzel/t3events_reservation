...
{
    /**
     * @var BookingsController|\PHPUnit_Framework_MockObject_MockObject|AccessibleMockObjectInterface
     */
    protected $subject;
    ...
    public function setUp()
    {
        ...
        $this->moduleData = $this->getMockBuilder(ModuleData::class)
            ->setMethods(['getOverwriteDemand', 'setOverwriteDemand', 'setDemand'])
            ->getMock();
